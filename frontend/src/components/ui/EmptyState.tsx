...
export function EmptyState({
  ...
  return (
    <div role="status" className="flex flex-col items-center gap-2 rounded-[var(--radius-md)] border border-dashed border-[var(--border-default)] bg-[var(--cream)]/50 px-4 py-12 text-center">
