...
| RAGOrchestrator | `app/services/rag_orchestrator.py` | working | Mode-aware: V1 (static) runs StaticRAGService only, V2 (web) runs WebRAGService only, V3 (rag_web) runs both in parallel; evidence merge, prompt building, LLM generation |
